...
export const translations = {
  en: {
    ...
    // Job descriptions
    'job.maze.description':
      "Joined an **early stage startup** which I helped grow to be what it is today. I've worked on the **most important part of the product** (unmoderated studies on the web) and helped build the new **Mobile App from scratch**",
    ...
    'job.sourcefabric.description':
      'Contributed heavily to the **new editor** of the open source CMS for journalists trusted by **national news agencies** and independent organisations all around the world',
    'job.sourcefabric.tech': 'Typescript, ReactJS',
    'job.stang.description':
...
**Most of my career has been remote.**`,
  ...
  es: {
    ...
    // Job descriptions
    'job.maze.description':
      "Me uní a una **'early stage' startup** que ayudé a crecer hasta lo que es hoy. He trabajado en la **parte más importante del producto** (unmoderated studies en la web) y ayudé a construir la nueva **aplicación móvil desde cero**",
    'job.maze.tech': 'TS, ReactJS, React Native, GraphQL, NodeJS, Neo4J, PostgreSQL',
    'job.prezly.description':
      'Ayudé a construir sus nuevos **frontends desde cero**, impulsados por su CMS',
    'job.prezly.tech': 'Typescript, ReactJS, NextJS',
    'job.sourcefabric.description':
      'Contribuí significativamente al **nuevo editor** del CMS de software libre para periodistas, utilizado por **agencias nacionales** y organizaciones independientes en todo el mundo',
    'job.sourcefabric.tech': 'Typescript, ReactJS',
    'job.stang.description':
      'Parte de un equipo de **3 desarrolladores**, construímos una herramienta para **automatizar la búsqueda anónima de empleo** para empresas',
    'job.stang.tech': 'PHP, JS, HTML/CSS, MySQL',
