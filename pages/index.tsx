  ...
  const jobs = [
    {
      ...
      tech: _("TS, ReactJS, React Native, GraphQL, NodeJS, Neo4J, PostgreSQL"),
    },
    {
      ...
      location: "100% " + _("Remote"),
      description: _(
        "Helped build their new CMS-powered frontends from scratch",
      ),
    ...
    },
    {
      ...
      period: "2016-2018",
      time: "2 " + _("years"),
      location: _("Marquette, Michigan (USA) and remote"),
      description: _(
...
const Other = () => (
  <>
    ...
    <div className="p-3 border-l border-accent2">
      ...
      <div>
        <strong>{_("Most of my career has been remote")}.</strong>
      </div>
    </div>
  </>
);
...
const Button: FunctionComponent<{
  ...
  <button
    ...
    className={classNames(
      ...
      {
        "bg-accent text-bg hover:bg-bg hover:text-fg":
...
const TopButtons = () => {
  ...
  return (
    <nav className="flex items-center justify-between w-full mt-4 print:hidden pb-2">
...
function Index() {
  ...
  return (
    <>
      <div className="max-w-4xl p-5 mx-auto min-h-screen">
        <TopButtons />
        <main>
          <div className="flex items-center justify-between px-2 py-1 text-md font-semibold border-t-4 border-accent text-accent">
        ...
        <footer className="relative mt-6 text-sm italic">
